...
# MAGIC To run this demo, just select the cluster `dbdemos-dlt-cdc-gustav_byberg` from the dropdown menu ([open cluster configuration](https://e2-demo-field-eng.cloud.databricks.com/#setting/clusters/0531-133255-ljyd406s/configuration)). <br />
...
# MAGIC <img width="1px" src="https://www.google-analytics.com/collect?v=1&gtm=GTM-NKQ8TT7&tid=UA-163989034-1&aip=1&t=event&ec=dbdemos&ea=VIEW&dp=%2F_dbdemos%2Fdata-engineering%2Fdlt-cdc%2F03-Retail_DLT_CDC_Monitoring&cid=1444828305810485&uid=3692557000280926">
...
# MAGIC %sql
# MAGIC
# MAGIC drop view sanjeev_catalog.demo.event_log_raw;

# COMMAND ----------

# MAGIC %sql
# MAGIC
# MAGIC CREATE VIEW IF NOT EXISTS sanjeev_catalog.demo.event_log_raw 
# MAGIC AS SELECT * 
# MAGIC FROM event_log("e73e48a6-e2ca-4d7e-9e93-fad518578a56");
# MAGIC
# MAGIC SELECT * from sanjeev_catalog.demo.event_log_raw;
...
# MAGIC        level, 
# MAGIC        details
# MAGIC   FROM sanjeev_catalog.demo.event_log_raw
...
# MAGIC
# MAGIC We can start creating our first <a href="/sql/dashboards/491a5284-4c68-421f-8676-1d978efd77c3" target="_blank">DBSQL Dashboard</a> monitoring our data quality & DLT pipeline health.
