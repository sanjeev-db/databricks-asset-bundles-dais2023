...
-- MAGIC <img width="1px" src="https://www.google-analytics.com/collect?v=1&gtm=GTM-NKQ8TT7&tid=UA-163989034-1&aip=1&t=event&ec=dbdemos&ea=VIEW&dp=%2F_dbdemos%2Fdata-engineering%2Fdlt-cdc%2F01-Retail_DLT_CDC_SQL&cid=1444828305810485&uid=3692557000280926">
...
-- MAGIC
-- MAGIC Your pipeline has been created! You can directly access the <a dbdemos-pipeline-id="dlt-cdc" href="/#joblist/pipelines/271ae1fb-a1ae-45a8-b61f-a644fb5e9c7a">Delta Live Table Pipeline for CDC</a>.
...
-- MAGIC %md
-- MAGIC ### Conclusion 
-- MAGIC We now have <a dbdemos-pipeline-id="dlt-cdc" href="/#joblist/pipelines/271ae1fb-a1ae-45a8-b61f-a644fb5e9c7a">our DLT pipeline</a> up & ready! Our `customers` table is materialize and we can start building BI report to analyze and improve our business. It also open the door to Data Science and ML use-cases such as customer churn, segmentation etc.
...
-- MAGIC
-- MAGIC <a href="/sql/dashboards/491a5284-4c68-421f-8676-1d978efd77c3" target="_blank">Data Quality Dashboard</a>
